...
//                     BITS_PER_INT);
//             visited = new ReplicatedShmemML1D<uint32_t>(visited_ints);
//             visited->zero();
//         }
// 
//         void clear() {
...
// 
//     private:
//         ReplicatedShmemML1D<uint32_t>* visited;
// };
// 
// 
...
//     }
// 
//     packed_edge init_val;
//     write_edge(&init_val, 0, 0);
// 
// #if 0
...
//         ShmemML1D<packed_edge> edges(nedges, init_val);
// 
...
// 
//         ShmemML1D<packed_edge> partitioned_edges(max_edges_per_pe * npes, init_val);
